COM_ENERGY = 14000. # GeV
MASS_POINT = 1000.0   # GeV
CROSS_SECTION = 399435E-03 # pb Atencion
CTAU_POINT = 1 # mm <- stop lifetime Atencion
...
#          BR         NDA      ID1       ID2
#      0.00000E+00    3     1000022         5     24  # dummy allowed decay, in order to turn on off-shell decays
...
#          BR         NDA      ID1       ID2
     ...
     0.00000000E+00    2     1000023         5   # BR(~b_1 -> ~chi_20 b )
     0.00000000E+00    2     1000025         5   # BR(~b_1 -> ~chi_30 b )
     0.00000000E+00    2     1000035         5   # BR(~b_1 -> ~chi_40 b )
     0.00000000E+00    2    -1000024         6   # BR(~b_1 -> ~chi_1- t )
...
#          BR         NDA      ID1       ID2
     ...
     0.00000000E+00    2     1000023         2   # BR(~u_L -> ~chi_20 u)
     0.00000000E+00    2     1000025         2   # BR(~u_L -> ~chi_30 u)
     0.00000000E+00    2     1000035         2   # BR(~u_L -> ~chi_40 u)
     0.00000000E+00    2     1000024         1   # BR(~u_L -> ~chi_1+ d)
     0.00000000E+00    2     1000037         1   # BR(~u_L -> ~chi_2+ d)
...
#          BR         NDA      ID1       ID2
     ...
     0.00000000E+00    2     1000023         2   # BR(~u_R -> ~chi_20 u)
     0.00000000E+00    2     1000025         2   # BR(~u_R -> ~chi_30 u)
     0.00000000E+00    2     1000035         2   # BR(~u_R -> ~chi_40 u)
...
#          BR         NDA      ID1       ID2
     ...
     0.00000000E+00    2     1000023         1   # BR(~d_L -> ~chi_20 d)
     0.00000000E+00    2     1000025         1   # BR(~d_L -> ~chi_30 d)
     0.00000000E+00    2     1000035         1   # BR(~d_L -> ~chi_40 d)
     0.00000000E+00    2    -1000024         2   # BR(~d_L -> ~chi_1- u)
     0.00000000E+00    2    -1000037         2   # BR(~d_L -> ~chi_2- u)
...
#          BR         NDA      ID1       ID2
     ...
     0.00000000E+00    2     1000023         1   # BR(~d_R -> ~chi_20 d)
     0.00000000E+00    2     1000025         1   # BR(~d_R -> ~chi_30 d)
     0.00000000E+00    2     1000035         1   # BR(~d_R -> ~chi_40 d)
...
#          BR         NDA      ID1       ID2
     ...
     0.00000000E+00    2     1000023         4   # BR(~c_L -> ~chi_20 c)
     0.00000000E+00    2     1000025         4   # BR(~c_L -> ~chi_30 c)
     0.00000000E+00    2     1000035         4   # BR(~c_L -> ~chi_40 c)
     0.00000000E+00    2     1000024         3   # BR(~c_L -> ~chi_1+ s)
     0.00000000E+00    2     1000037         3   # BR(~c_L -> ~chi_2+ s)
...
#          BR         NDA      ID1       ID2
     ...
     0.00000000E+00    2     1000023         4   # BR(~c_R -> ~chi_20 c)
     0.00000000E+00    2     1000025         4   # BR(~c_R -> ~chi_30 c)
     0.00000000E+00    2     1000035         4   # BR(~c_R -> ~chi_40 c)
...
#          BR         NDA      ID1       ID2
     ...
     0.00000000E+00    2     1000023         3   # BR(~s_L -> ~chi_20 s)
     0.00000000E+00    2     1000025         3   # BR(~s_L -> ~chi_30 s)
     0.00000000E+00    2     1000035         3   # BR(~s_L -> ~chi_40 s)
     0.00000000E+00    2    -1000024         4   # BR(~s_L -> ~chi_1- c)
     0.00000000E+00    2    -1000037         4   # BR(~s_L -> ~chi_2- c)
...
#          BR         NDA      ID1       ID2
     ...
     0.00000000E+00    2     1000023         3   # BR(~s_R -> ~chi_20 s)
     0.00000000E+00    2     1000025         3   # BR(~s_R -> ~chi_30 s)
     0.00000000E+00    2     1000035         3   # BR(~s_R -> ~chi_40 s)
...
#
#         PDG            Width
DECAY   1000022           3.291059812e-15   # neutralino1 decays
#          BR         NDA      ID1       ID2
#     -0.50000000E+00    2          11       -11   # BR(~chi_10 -> e+   e-)
#     -0.50000000E+00    2          13       -13   # BR(~chi_10 -> mu+   u-)
     0.250000000E+00    3          11       -11       12   # BR(~chi_10 -> e+   e-   nu_e)
     0.250000000E+00    3          13       -13       14   # BR(~chi_10 -> mu+   u-   nu_mu)
     0.250000000E+00    3          11       -11       14   # BR(~chi_10 -> e+   e-   nu_mu)
     0.250000000E+00    3          13       -13       12   # BR(~chi_10 -> mu+   u-   nu_e)
#
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/EXO-RunIIFall17GS-01595-fragment.py nevts:398'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:../GEN_root_files/EXO-DisplacedSUSY_squarkToQuarkChi_MSquark_1000_MChi_148_ctau_60mm_TuneCP5_14TeV_pythia8_GEN.root'),
